        ...
        return (
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    {/* <DropdownMenuItem onClick={() => router.push(`/customers/form?customerId=${row.original.id}`)}>Edit</DropdownMenuItem> */}
                    <DropdownMenuItem>
                        <Link href={`/tickets/form?customerId=${row.original.id}`} className="w-full" prefetch={false}>New Ticket</Link>    
                    </DropdownMenuItem>
                    <DropdownMenuItem>
                        <Link href={`/customers/form?customerId=${row.original.id}`} className="w-full" prefetch={false}>Edit Customer</Link>    
                    </DropdownMenuItem>
                </DropdownMenuContent>
            </DropdownMenu>
        )
